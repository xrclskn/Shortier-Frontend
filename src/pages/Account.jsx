        ...
        <main className="space-y-4">
            ...
            <div className="flex bg-white rounded-lg p-4 border-gray-200">
                <button
                    ...
                    className={`px-4 py-2 rounded-lg font-medium ${activeTab === 'profile' ? 'bg-blue-500 text-white' : 'text-gray-500 hover:text-gray-700'}`}
                >
                    Profil & Şifre
                </button>
                <button
                    onClick={() => setActiveTab('account')}
                    className={`px-4 py-2 rounded-lg font-medium ${activeTab === 'account' ? 'bg-blue-500 text-white' : 'text-gray-500 hover:text-gray-700'}`}
                >
                    Hesap & Oturum
                </button>
            </div>
