...
import ShortierReportExporter from "@/components/analytics/ShortierReportExporter.jsx";
...
export default function Statistics() {
    ...
    const { data: stats, isLoading: loading, isFetching, error, refetch } = useStatistics(selectedPeriod);
    ...
    const handleRefresh = async () => {
        try {
            ...
            // hata loglanabilir, ek bir şey yapmak istersen
                    ...
                    return (
                        ...
                        >
                            <button
                                ...
                                tabIndex={locked ? -1 : 0}
                                className={`px-5 py-2.5 rounded-lg text-sm font-medium transition-all flex items-center ${isActive
                                    ? "bg-[#010101] text-white shadow-custom"
                                    : locked
    ...
    const OverviewCards = () => (
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6">
            ...
            <StatCard
                ...
                trendBg="bg-gray-100"
                trendText="text-[#010101]"
                value={isFetching ? null : `${calculateCTR()}%`}
    ...
    const Spinner = () => (
        <svg className="animate-spin h-6 w-6 text-[#010101]" viewBox="0 0 24 24">
            <circle
    ...
    const LinksSection = () => (
        <div className="grid grid-cols-1 xl:grid-cols-5 gap-6">
            ...
            <div className="xl:col-span-3 bg-white rounded-2xl p-8 shadow-custom border border-gray-100">
                ...
                <ScrollableList loading={isFetching}>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-custom border border-gray-100">
                <div className="flex flex-col gap-5 md:gap-0 md:flex-row items-center justify-between mb-8">
                    ...
                    <div className="flex items-center space-x-4">
                        <LegendDot colorClass="bg-[#010101]" label="Görüntülenme" />
                        <LegendDot colorClass="bg-gray-400" label="Tıklama" />
                    </div>
                </div>

                <StatsChart stats={stats} loading={isFetching} />
            </div>
    ...
    const DeviceRow = ({ device }) => (
        <div>
            <div className="flex items-center justify-between mb-3">
                <div className="flex items-center space-x-3">
                    {device.name === "Desktop" && (
                        <Monitor className="text-[#010101]" size={20} />
                    )}
                    {device.name === "Mobile" && (
            ...
            <div className="w-full bg-gray-100 rounded-full h-3">
                <div
                    className="bg-gradient-to-r from-gray-800 to-gray-600 h-3 rounded-full shadow-custom"
                    style={{
    ...
    const LocationRow = ({ location }) => (
        <div className="p-4 rounded-xl hover:bg-gray-50 transition-all border border-gray-100">
            ...
            <div className="w-full bg-gray-100 rounded-full h-2">
                <div
                    className="bg-gradient-to-r from-gray-800 to-gray-600 h-2 rounded-full shadow-custom"
                    style={{
                ...
                <div className="flex items-center justify-between mb-8">
                    <div className="flex items-center space-x-3">
                        <div className="w-12 h-12 bg-gray-100 rounded-xl flex items-center justify-center">
                            <Users className="text-[#010101]" size={24} />
                        </div>
                        <div>
                            <h2 className="text-2xl font-bold text-gray-900">
                                Ziyaretçi Analizi
    ...
    // ---- render ----
    return (
        <div className="min-h-screen bg-[#eeefe6]">
                ...
                <nav className="bg-white rounded-lg border-gray-200 sticky top-0 z-50 shadow-custom border">
                    <div className="mx-auto px-6 py-4">
                        <div className="flex flex-col md:flex-row gap-5 md:gap-0 items-center justify-between">
                            {/* Logo / brand */}
                            <h1 className="text-3xl font-bold font-handwritten text-[#010101]">
                                Shortier
                            </h1>
