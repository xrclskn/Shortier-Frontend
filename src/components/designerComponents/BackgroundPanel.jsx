        ...
        <div className="space-y-6">
          ...
          `}
            ...
            {activeTab === 'gradient' && (
                <div className="space-y-4">
                    ...
                    <div>
                        ...
                        <div className="flex items-center space-x-3">
                            ...
                            <input
                                ...
                                value={theme.gradientStart || '#8B5CF6'}
                                onChange={(e) => handleGradientChange(e.target.value, theme.gradientEnd)}
                                className="flex-1 px-4 py-2 border border-gray-200 rounded-lg font-mono text-sm focus:outline-none focus:ring-2 focus:ring-purple-500"
                                placeholder="#8B5CF6"
                            />
                        </div>
                    </div>
                    ...
                    <button
                        ...
                        className="w-full flex items-center justify-center space-x-2 px-4 py-3 bg-gradient-to-r from-purple-500 to-pink-500 text-white rounded-lg hover:from-purple-600 hover:to-pink-600 transition-all font-medium shadow-sm"
                    >
                        <RefreshCw size={18} />
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 flex items-start space-x-3">
                ...
                <div>
                    <h4 className="font-semibold text-blue-900 text-sm mb-1">Renk Seçimi İpucu</h4>
