                    ...
                    <div className="flex-1">
                        ...
                        <div className="flex space-x-2 mt-2">
                            ...
                            <button
                                ...
                                className="flex items-center space-x-1 px-3 py-1 bg-blue-100 hover:bg-blue-200 text-blue-600 rounded-lg text-sm transition-colors"
                            >
                                    ...
                                    {palette.colors.map((color, index) => (
                                        <button
                                            ...
                                            className={`w-8 h-8 rounded-lg border-2 transition-all duration-200 hover:scale-110 ${
                                                value === color ? 'border-gray-800 shadow-lg' : 'border-gray-300'
                                            }`}
            ...
            <div className="space-y-3">
                <div className="flex items-center justify-between">
                    ...
                    <button
                        ...
                        className="flex items-center space-x-1 px-2 py-1 bg-blue-100 text-blue-600 rounded-lg text-sm hover:bg-blue-200 transition-colors"
                    >
