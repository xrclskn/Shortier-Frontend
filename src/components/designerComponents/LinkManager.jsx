...
const LinkManager = ({
    ...
    const handleDeleteLink = async (linkId) => {
        ...
        try {
            ...
            alert("Link silinemedi. Lütfen tekrar deneyin.");
        }
    };
    ...
    const handleToggleVisibility = (linkId) => {
        ...
        if (link) {
            ...
            linkVisibilityChange(linkId, newVisibility).catch(error => {
                ...
                alert("Link görünürlüğü değiştirilemedi. Lütfen tekrar deneyin.");
            });
        }
    };
                ...
                {links.length === 0 ? (
                    <div className="flex flex-col items-center text-center py-12 bg-gray-50 rounded-lg border-2 border-dashed border-gray-300">
                        ...
                        <p className="text-sm mt-1 text-slate-500">
                            ...
                            <span className="font-medium text-blue-600">"Yeni Link Ekle"</span>
                            {" "}butonuna tıkla.
                        </p>
                    </div>
                ) : (
                    links
                        ...
                        .map((link, index) => (
                            <div
                                ...
                                className={`group bg-white border rounded-xl p-4 hover:border-blue-500 transition ${
