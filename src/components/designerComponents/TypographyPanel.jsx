    ...
    return (
        <div className="space-y-6">
            ...
            <div>
                ...
                <div className="relative">
                    ...
                    <button
                        ...
                        className="w-full flex items-center justify-between px-4 py-3 bg-white border-2 border-gray-200 rounded-lg hover:border-purple-300 transition-colors focus:outline-none focus:border-purple-500"
                    >
                        <div className="flex items-center space-x-3">
                            ...
                            <div className="text-left">
                                <div className="font-medium text-gray-900 flex items-center gap-2">
                                    ...
                                    {/* 🔁 BURASI DEĞİŞTİ 🔁
                                       Seçili font Pro olsa bile, kullanıcı Pro değilse BADGE GÖSTERME.
                                       Yani: sadece (currentFontObj.proOnly && isPro) durumunda badge çıkar.
                                    */}
                                ...
                                return (
                                    <button
                                        ...
                                        className={`
                                            ...
                                            ${isActive ? 'bg-purple-50 border-l-4 border-purple-500' : 'border-l-4 border-transparent'}
                                            ${locked
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 flex items-start space-x-3">
                ...
                <div>
                    <h4 className="font-semibold text-blue-900 text-sm mb-1">Font İpucu</h4>
