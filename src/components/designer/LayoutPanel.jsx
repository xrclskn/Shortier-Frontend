    ...
    const RangeControl = ({ label, value, min, max, step = 1, suffix = 'px', onChange }) => (
        <div className="space-y-3">
            ...
            <div className="relative">
                ...
                />
                <div
                    className="absolute top-1 h-0 w-0 border-l-4 border-r-4 border-b-4 border-l-transparent border-r-transparent border-b-[#010101]"
                    style={{
                    ...
                    {alignmentOptions.map((option) => {
                        ...
                        return (
                            <button
                                ...
                                className={`p-3 rounded-lg border-2 transition-all duration-200 ${layoutSettings.alignment === option.id
                                    ? 'border-[#010101] bg-[#efefef] text-[#010101]'
                    ...
                    {cardStyles.map((style) => {
                        ...
                        return (
                            <button
                                ...
                                className={`p-4 rounded-lg border-2 transition-all duration-200 ${layoutSettings.cardStyle === style.id
                ...
                <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-3">
                        <div className="p-2 bg-gray-200 rounded-lg">
                            <Layout className="w-5 h-5 text-[#010101]" />
                        </div>
                        <div>
