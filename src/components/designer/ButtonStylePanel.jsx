    ...
    return (
        <div className="space-y-6">
            ...
            <div className="flex items-center justify-between">
                ...
                <Sparkles className="text-[#010101]" size={24} />
            </div>
                ...
                `}
                            >
                                <div className="flex flex-col items-center space-y-2">
                                    <Icon
                                        size={32}
                                        className={isSelected ? 'text-[#010101]' : 'text-gray-600'}
                                    />
                                    <div className="text-center">
                                        <div className={`font-semibold text-sm ${isSelected ? 'text-[#010101]' : 'text-gray-900'}`}>
                                            {style.name}
                                        </div>
                                ...
                                {isSelected && (
                                    <div className="absolute -top-2 -right-2 w-6 h-6 bg-[#010101] rounded-full flex items-center justify-center">
            ...
            <div>
                ...
                `}
                            >
                                <div
                                    className="w-full h-8 bg-gradient-to-r from-gray-700 to-black rounded"
                                    style={{ boxShadow: shadow.value }}
                                />
                                <p className={`text-xs font-medium mt-2 ${isSelected ? 'text-[#010101]' : 'text-gray-600'}`}>
                                    {shadow.name}
                                </p>
                            </button>
                        );
            ...
            <div className="bg-[#efefef] border border-gray-300 rounded-lg p-4 flex items-start space-x-3">
                <div className="flex-shrink-0 mt-0.5">
                    <div className="w-8 h-8 bg-gray-200 rounded-full flex items-center justify-center">
                        <Sun className="text-[#010101]" size={16} />
                    </div>
                </div>
                <div>
                    <h4 className="font-semibold text-gray-900 text-sm mb-1">Önemli Not</h4>
