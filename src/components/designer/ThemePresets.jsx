        ...
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
              ...
              `}
                            ...
                            >
                                ...
                                {isSelected && (
                                    <div className="absolute top-2 right-2 w-8 h-8 bg-white rounded-full flex items-center justify-center shadow-lg">
                                        <Check className="text-[#010101]" size={18} strokeWidth={3} />
                                    </div>
                                )}
                ...
                ${isSelected ? 'border-[#010101] bg-[#efefef]' : 'border-gray-100'}
              `}>
                                <div className="flex items-center justify-between">
                                    <div className="text-left">
                                        <p className={`
                      font-semibold text-sm
                      ${isSelected ? 'text-[#010101]' : 'text-gray-900'}
                    `}>
                                            {preset.name}
                                        </p>

                                        {isSelected && (
                                            <p className="text-xs text-[#010101] mt-1">✓ Aktif Tema</p>
                                        )}
                                    </div>
            ...
            <div className="bg-[#efefef] border border-gray-300 rounded-lg p-4 flex items-start space-x-3">
                ...
                <div>
                    <h4 className="font-semibold text-gray-900 text-sm mb-1">Tema İpucu</h4>
