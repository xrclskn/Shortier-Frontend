    ...
    const renderIconItem = (iconData, index) => {
        ...
        if (viewMode === 'list') {
            return (
                <button
                    ...
                    className={`flex items-center gap-3 w-full p-3 rounded-lg border-2 transition-all duration-200 ${isSelected
                ...
                >
                    ...
                    {isSelected && (
                        <Check size={16} className="text-[#010101] ml-auto" />
                    )}
                </button>
            );
        }
        ...
        return (
            <button
                key={iconData.name}
                onClick={() => handleIconClick(iconData.name)}
                className={`relative p-3 rounded-lg border-2 transition-all duration-200 group ${isSelected
                        ? 'border-[#010101] bg-[#efefef] shadow-md'
            ...
            >
                ...
                {isSelected && (
                    <div className="absolute -top-1 -right-1 w-5 h-5 bg-[#010101] rounded-full flex items-center justify-center">
        ...
        <div className="space-y-6">
            ...
            <div className="relative">
                ...
                <input
                    ...
                    className="w-full pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#010101] focus:border-transparent"
                />
            </div>
            ...
            <div className="flex items-center gap-2 overflow-x-auto scrollbar-hide">
                <button
                    ...
                    className={`px-3 py-1 rounded-full text-sm font-medium whitespace-nowrap transition-colors ${activeCategory === 'all'
                ...
                {Object.entries(iconCategories).map(([key, category]) => (
                    <button
                        ...
                        className={`px-3 py-1 rounded-full text-sm font-medium whitespace-nowrap transition-colors ${activeCategory === key
                                ? 'bg-[#010101] text-white'
                                : 'bg-gray-100 text-gray-600 hover:bg-gray-200'
                            }`}
                    >
            ...
            {/* Icons Grid/List */}
            <div className={`max-h-80 overflow-y-auto ${viewMode === 'grid'
                            ...
                            <div className="flex flex-wrap gap-1 mt-2">
                                {colorPresets.map(color => (
                                    <button
                                        ...
                                        className={`w-6 h-6 rounded border-2 hover:scale-110 transition-transform ${tempIconColor === color ? 'border-gray-900' : 'border-gray-300'
                                            }`}
                                ...
                                <div className="flex flex-wrap gap-1 mt-2">
                                    {backgroundPresets.map(color => (
                                        <button
                                            ...
                                            className={`w-6 h-6 rounded border-2 hover:scale-110 transition-transform ${tempIconBg === color ? 'border-gray-900' : 'border-gray-300'
            ...
            <div className="flex items-center justify-between pt-4 border-t border-gray-200">
                ...
                <div className="flex items-center gap-3">
                    ...
                    <button
                        onClick={handleApply}
                        className="px-4 py-2 bg-[#010101] text-white rounded-lg hover:bg-gray-800 transition-colors"
                    >
                        Apply
                    </button>
                </div>
